// pages/TermsPage.tsx
// Términos y Condiciones + Política de Privacidad (/terminos). Documento legal
// estático, enlazado desde el checkbox de consentimiento del registro.
...
export default function TermsPage() {
  ...
  // Si se abrió en pestaña nueva (link del registro), no hay historial previo
  // (location.key === 'default'): en ese caso volvemos al registro en vez de -1.
  const goBack = () => {
    ...
    <div className="min-h-dvh w-full bg-white text-ink">
      ...
      <main className="mx-auto max-w-2xl px-5 pb-16 pt-4">
        ...
        <P>
          ...
          Condiciones y la Política de Privacidad. Si no estás de acuerdo, no debés registrarte ni usar
          la Plataforma.
        </P>

        <H2>2. Qué es ClubPlaza</H2>
        <P>
          ClubPlaza es el club de beneficios del shopping Green Plaza. Es una plataforma web donde los
          usuarios se registran como socios, acceden a las promociones y descuentos ofrecidos por los
          locales del shopping, y obtienen una credencial digital para utilizarlos.
        </P>

        <H2>3. Titular</H2>
        <P>
          La Plataforma es operada por EL BENJA S.R.L., CUIT 33-71522848-9, con domicilio en Tres Arroyos
          2388, PB, Ciudad Autónoma de Buenos Aires (CABA) (en adelante, “Green Plaza”), responsable del
          club y de los datos de los socios.
        </P>
        ...
        <P>
          Te comprometés a no usar la Plataforma con fines fraudulentos, a no intentar vulnerar su
          seguridad, a no duplicar ni ceder tu credencial, y a no usar beneficios de forma abusiva o
          contraria a su finalidad.
        </P>

        <H2>9. Disponibilidad del servicio</H2>
        <P>
          La Plataforma se ofrece “tal como está”. Green Plaza procura su disponibilidad y buen
          funcionamiento, pero no garantiza que sea ininterrumpida o libre de errores, y puede realizar
          tareas de mantenimiento o modificaciones.
        </P>

        <H2>10. Modificaciones</H2>
        <P>
          Green Plaza puede modificar estos Términos y los beneficios en cualquier momento. Los cambios
          rigen desde su publicación en la Plataforma. El uso continuado implica su aceptación.
        </P>
        ...
        <P>
          El responsable de la base de datos de socios es EL BENJA S.R.L., CUIT 33-71522848-9, domicilio en
          Tres Arroyos 2388, PB, Ciudad Autónoma de Buenos Aires (CABA), email de contacto <Mail />.
        </P>

        <H2>2. Qué datos recopilamos</H2>
        <P>
          Al registrarte recopilamos: nombre y apellido, email, número de celular, DNI y fecha de
          nacimiento. Además, podemos registrar datos de uso de la Plataforma (beneficios utilizados, fecha
          y local de los escaneos de tu credencial y, en el futuro, puntos acumulados).
        </P>
        ...
        <P>
          El tratamiento de tus datos se basa en el consentimiento que otorgás al registrarte, conforme a la
          Ley 25.326 de Protección de Datos Personales. Podés retirar tu consentimiento en cualquier momento
          solicitando la baja.
        </P>
        ...
        <P>
          ...
          intervalos no inferiores a seis meses, salvo que se acredite un interés legítimo. La AGENCIA DE
          ACCESO A LA INFORMACIÓN PÚBLICA, órgano de control de la Ley 25.326, tiene la atribución de atender
          las denuncias y reclamos que se interpongan con relación al incumplimiento de las normas sobre
          protección de datos personales.
        </P>

        <H2>9. Datos de menores</H2>
        <P>
          La Plataforma está dirigida a mayores de 18 años. No recopilamos intencionalmente datos de menores
          sin autorización de sus representantes legales.
        </P>

        <H2>10. Cambios en esta Política</H2>
        <P>
          Podemos actualizar esta Política de Privacidad. Publicaremos los cambios en la Plataforma con su
        ...
        <p className="mt-8 border-t border-line-soft pt-5 text-[13px] italic leading-relaxed text-mute">
          Al registrarte en ClubPlaza declarás haber leído y aceptado los Términos y Condiciones y la
